...
The first step is to download the [pho-cli PHAR file](https://github.com/phonetworks/pho-cli/raw/pho.phar) and move it to your `/usr/local/bin` or an equivalent.

```shell
cd /tmp
wget https://github.com/phonetworks/pho-cli/raw/pho.phar
